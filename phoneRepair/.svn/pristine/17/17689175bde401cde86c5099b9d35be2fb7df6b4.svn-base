  ...
  <!--<![endif]-->
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <li><a href="/phoneRepair/user?method=getAllUser&currPage=1&pageSize=5">所有用户</a> <span class="divider">/</span></li>
        </ul>
...
<div class="btn-toolbar">
    ...
    <a href="#myModal" data-toggle="modal" class="btn">取消修改</a>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    ...
    <form action="/phoneRepair/user?method=editUser&uid=${user.uid }&currPage=1&pageSize=5" method="post" sid="tab">
        <label>联系方式</label>
        <input type="text" name ="username" value="${user.username }" class="input-xlarge">
        <label>姓名</label>
        <input type="text" name="name" value="${user.name }" class="input-xlarge">
        <label>积分</label>
        <input type="text" name="score" value="${user.score }" class="input-xlarge">
        <label>新密码</label>
