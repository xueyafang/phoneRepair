...
<!-- saved from url=(0040)http://www.caobao.com/orders/repair.html -->
<html lang="zh-CN">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>维修订单- 草包网</title>
<link rel="stylesheet" type="text/css"
	href="/phoneRepair/admin/lib/bootstrap/css/bootstrap.css">
...
<link rel="stylesheet" type="text/css"
	href="/phoneRepair/css/repair/same.css">
<link rel="stylesheet" type="text/css"
	href="/phoneRepair/css/repair/xcConfirm.css">
<!-- <link rel="stylesheet" href="../css/header.css" /> -->
<!-- 自定义CSS文件 部分 -->

<link rel="stylesheet" type="text/css"
	href="/phoneRepair/css/repair/users-same.css">
<link rel="stylesheet" type="text/css"
	href="/phoneRepair/css/repair/orders-repair.css">

<!-- 自定义CSS文件 结束 -->

<!-- jQuery文件。务必在bootstrap.min.js 之前引入 -->
<script src="../js/jquery-1.11.3.min.js "></script>
<script src="./维修订单- 草包网_files/html5shiv.min.js "></script>
	...
	<div class="header">
		<div class="header-out">
			<div class="header_top wrap">
				<link rel="stylesheet" type="text/css"
					href="/phoneRepair/css/repair/widget-user.css ">
				<div class="tabnav">

					<ul class="tabbd">
						<!-- <li class="by"><a href="/buy/cart.html"><i class="buycar"></i><span>(0)</span></a></li> -->
						<li class="tabbdli user-name">
							<a rel="nofollow"
							href="./userindex.jsp">${user.name }
								<img
							...
							<div class="drop-down"
								...
								<div class="all-drop-down">
									<p class="index">
										<a rel="nofollow" href="/phoneRepair/jsp/index.jsp"
											class="logout_a">返回首页</a>
									</p>
									<p class="logout">
										<a rel="nofollow" href="/phoneRepair/user?method=outLogin"
		...
		<div class="con wrap clearfix">
			...
			<!-- 菜单 开始 -->
			<link rel="stylesheet" type="text/css"
				href="/phoneRepair/css/repair/users-menu.css">
					...
					<ul class="level2">
						<li class="levelitem open">
							...
							<ul class="level3">
								...
								<li><a
									href="/phoneRepair/order?method=showOrders&uid=${user.uid }">我的订单</a></li>
							</ul>
						</li>
					</ul>
				</div>
			...
			<div class="con-right">
				<div class="bd-t">
					<div class="tab-container-inner">
						<div class="tabWrap">
							<ul class="tabs ">
								<li class="tab current"><a href="./repair.jsp">维修订单</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="bd-b">
					...
					<ul class="ul_tit">
						<li class="one bigW">订单号</li>
						<li class="five bigM">维修点名</li>
						<li class="six bigM">时间</li>
					</ul>

					<c:forEach items="${list1}" var="list1">
						<ul class="ul_tit">
							<li class="one bigW"><a
								href="/phoneRepair/order?method=showOrder&oid=${list1[0] }&flag=0">${list1[0]}</a></li>
							<li class="five bigM">${list1[1]}</li>
							<li class="six bigM">${list1[2]}</li>
						</ul>
					</c:forEach>
					<div class="pagination" style="margin-left: 300px;">
						<ul>
							<li><a
								href="/phoneRepair/order?method=showOrders&uid=${user.uid }&currPage=1&pageSize=3">首&nbsp;&nbsp;&nbsp;页</a></li>
							<c:if test="${pageBean.currPage!=1 }">
								<li><a
									href="/phoneRepair/order?method=showOrders&uid=${user.uid }&currPage=${pageBean.currPage-1 }&pageSize=3">上一页</a></li>
							</c:if>
							<c:if test="${pageBean.currPage==1 }">
								<li><a
									href="/phoneRepair/order?method=showOrders&uid=${user.uid }&currPage=1&pageSize=3">上一页</a></li>
							</c:if>
							<li><a
								href="/phoneRepair/order?method=showOrders&uid=${user.uid }&currPage=${pageBean.currPage }&pageSize=3">第&nbsp;${pageBean.currPage }&nbsp;页</a></li>
							<c:if test="${pageBean.currPage != pageBean.totalPage }">
								<li><a
									href="/phoneRepair/order?method=showOrders&uid=${user.uid }&currPage=${pageBean.currPage+1 }&pageSize=3">下一页</a></li>
							</c:if>
							<c:if test="${pageBean.currPage == pageBean.totalPage }">
								<li><a
									href="/phoneRepair/order?method=showOrders&uid=${user.uid }&currPage=${pageBean.totalPage }&pageSize=3">下一页</a></li>
							</c:if>
							<li><a
								href="/phoneRepair/order?method=showOrders&uid=${user.uid }&currPage=${pageBean.totalPage }&pageSize=3">尾&nbsp;&nbsp;&nbsp;页</a></li>
						</ul>
					</div>
					<!-- <ul class="ul_bd">
					<li class="null">维修订单还是空的</li>
				</ul> -->
				</div>
				<div class="pageLink clearfix"></div>
			</div>
		</div>
		...
		<!-- 页脚部分 开始 -->
		<link rel="stylesheet" type="text/css"
			href="/phoneRepair/css/repair/footer.css">
			...
			<div class="footer wrap">
				...
				<div class="row-fluids safeInfo">
					<a rel="nofollow" target="_blank"
						...
						src="./维修订单- 草包网_files/sznet110.jpg " height="34" alt="深圳网络警察报警平台"></a>
					<a rel="nofollow" target="_blank"
						href="http://www.cyberpolice.cn/wfjb/"><img
						src="./维修订单- 草包网_files/cyberpolice.jpg " height="34"
						...
						target="_blank"><img src="./维修订单- 草包网_files/hy_124x47.png "
						...
						src="./维修订单- 草包网_files/bottom_large_img.png " height="34"></a>
				</div>
		...
		<!-- 侧边栏 开始 -->
		<link rel="stylesheet" type="text/css"
			href="/phoneRepair/css/repair/sidebar.css">
		...
		<div class="cb_sidebar" style="top: 57px;">
			...
			<div class="cb_sidebar_tabs">
				<ul>
					<li class="cbwlogo" style="display: none;"><a
						href="/phoneRepair/jsp/index.jsp" title="咻一修"> <i></i>
					</a></li>
		...
		<script type="text/javascript">
			...
			function smallHide() {
				...
				$(".cb_sidebar_tabs ul li.cart").css({
		...
		<!-- 全局js文件 -->
		<script type="text/javascript" src="./维修订单- 草包网_files/common.js"></script>
		<script type="text/javascript" src="./维修订单- 草包网_files/xcConfirm.js"></script>
