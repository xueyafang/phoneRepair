...
<link rel="stylesheet" type="text/css" href="../css/userinfo/same.css">
<link rel="stylesheet" type="text/css"
	href="../css/userinfo/xcConfirm.css">
<!-- <link rel="stylesheet" href="/Public/Home/css/header.css" /> -->
<!-- 自定义CSS文件 部分 -->

<link rel="stylesheet" type="text/css"
	href="../css/userinfo/users-same.css">
<link rel="stylesheet" type="text/css"
	href="../css/userinfo/users-info.css">

<!-- 自定义CSS文件 结束 -->

<!-- jQuery文件。务必在bootstrap.min.js 之前引入 -->
<script src="../js/jquery-1.11.3.min.js"></script>
<script src="../js/list_js/html5shiv.min.js"></script>
	...
	<div class="header">
		<div class="header-out">
			<div class="header_top wrap">
				...
				<link rel="stylesheet" type="text/css"
					href="/phoneRepair/css/userinfo/widget-user.css">
				<div class="tabnav">

					<ul class="tabbd">
						<!-- <li class="by"><a href="/buy/cart.html"><i class="buycar"></i><span>(0)</span></a></li> -->
						<li class="tabbdli user-name">
							<a rel="nofollow" href="./userindex.jsp">${user.name}<img
								src="../img/headimg.jpg"
		...
		<div class="con wrap clearfix">
			...
			<!-- 菜单 开始 -->
			<link rel="stylesheet" type="text/css"
				href="../css/userinfo/users-menu.css">

			<!--菜单 开始-->
			<div class="con-left">
				<div class="con-l-t">
					<a><img src="../img/headimg.jpg"
						onerror="javascript:this.src=&#39;/Public/User/default.jpg&#39;;"
						title="点击编辑头像"></a>
					<p class="name">${user.name }<span class="novip">VIP</span>
					</p>
				</div>
				<div class="con-l-b">
					<ul class="level2">
			...
			<div class="con-right">
				<div class="bd-t">
					<div class="tab-container-inner">
						<div class="tabWrap">
							<ul class="tabs ">
								<li class="tab current"><a href="javascript:void(0);">个人信息</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="prolist">
					...
					<div class="clearfix">
						<div class="pro_left">
							<div class="_left_top">
								<form id="info"
									action="http://www.caobao.com/users/updateinfo.html"
									method="post">
									<span class="one"> <strong>姓名</strong> <input
										type="text" name="username" value="${user.name }"
										placeholder="您的姓名" /><br />
									</span> <span> <strong>电话号码</strong> <input type="text"
										name="name" value="" placeholder="${user.username }">
									</span> <span class="save"> <a href="javascript:;">保存</a>
									</span>
								</form>
							</div>
						</div>
			...
			<div class="footer wrap">
				...
				<div class="row-fluids safeInfo">
					<a rel="nofollow" target="_blank"
						...
						src="./个人信息- 草包网_files/sznet110.jpg.下载" height="34"
						alt="深圳网络警察报警平台"></a> <a rel="nofollow" target="_blank"
						href="http://www.cyberpolice.cn/wfjb/"><img
						src="./个人信息- 草包网_files/cyberpolice.jpg.下载" height="34"
						...
						target="_blank"><img src="./个人信息- 草包网_files/hy_124x47.png.下载"
						...
						src="./个人信息- 草包网_files/bottom_large_img.png.下载" height="34"></a>
				</div>
		...
		<!-- 侧边栏 开始 -->
		<link rel="stylesheet" type="text/css"
			href="../css/userinfo/sidebar.css">




		<!-- 全局js文件 -->
		<script type="text/javascript" src="./个人信息- 草包网_files/common.js.下载"></script>
		<script type="text/javascript" src="./个人信息- 草包网_files/xcConfirm.js.下载"></script>
		<!--[if lt IE 9]>
